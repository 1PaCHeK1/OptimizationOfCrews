...
class TaskAssignment:
    ...
    def __init__(self, brigades, deliverys, mode='all_permutation'):
        ...
        if mode == 'all_permutation':
            self.min_cost, self.best_solution = self.all_permutation(self.matrix)
        elif mode == 'Hungary':
            self.min_cost, self.best_solution = self.Hungary(self.matrix)
